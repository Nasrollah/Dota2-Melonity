write (6,*) '----------------------------------------------'
write (6,*) 'PS_WENO euler flux general in x'
write (6,*) Index_x, Distributed_x, Order_x, dx
...
write (6,*) 'DF1 : ',MINVAL(D_Flux(:,:,1)),MAXVAL(D_Flux(:,:,1))
write (6,*) 'DF2 : ',MINVAL(D_Flux(:,:,2)),MAXVAL(D_Flux(:,:,2))
write (6,*) 'DF3 : ',MINVAL(D_Flux(:,:,3)),MAXVAL(D_Flux(:,:,3))
write (6,*) 'DF4 : ',MINVAL(D_Flux(:,:,4)),MAXVAL(D_Flux(:,:,4))
write (6,*) 'DF5 : ',MINVAL(D_Flux(:,:,5)),MAXVAL(D_Flux(:,:,5))
